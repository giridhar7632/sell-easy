  ...
  return (
    <Layout meta={{ name: 'Privacy Policy' }}>
      <div class="prose mx-auto xl:prose-lg">
        ...
        <p>
          {' '}
          Sell Easy (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy
          Policy explains how your personal information is collected, used, and disclosed by Sell
          Easy.
        </p>
        <p>
          This Privacy Policy applies to our website, and its associated subdomains (collectively,
          our “Service”) alongside our application, Sell Easy. By accessing or using our Service,
        ...
        <ul>
          ...
          <li>
            Customer:refers to the company, organization or person that signs up to use the Sell
            Easy Service to manage the relationships with your consumers or service users.
          </li>
          <li>
            Device:any internet connected device such as a phone, tablet, computer or any other
            device that can be used to visit Sell Easy and use the services.
          </li>
          <li>
          ...
          <li>
            Personnel:refers to those individuals who are employed by Sell Easy or are under
        ...
        <p />
        <h2>When does Sell Easy use end user information from third parties?</h2>
        <p>
          Sell Easy will collect End User Data necessary to provide the Sell Easy services to our
          customers.
        </p>
        <p>
        ...
        <h2>When does Sell Easy use customer information from third parties?</h2>
        <p>
          We receive some information from the third parties when you contact us. For example, when
          you submit your email address to us to show interest in becoming a Sell Easy customer, we
          receive information from a third party that provides automated fraud detection services to
          Sell Easy. We also occasionally collect information that is made publicly available on
          social media websites. You can control how much of your information social media websites
        ...
        <p>
          ...
          service and fulfilling orders for products and services you may purchase through the app.
          We will likely share your personal information, and possibly some non-personal
          information, with these third parties to enable them to perform these services for us and
          for you.
        </p>
        <p>
          ...
          other technographics such as connection speed, whether you have visited the app in a
          ...
          research and reporting for us and our advertisers.&nbsp;We may also disclose personal and
          non-personal information about you to government or law enforcement officials or private
          parties as we, in our sole discretion, believe necessary or appropriate in order to
          respond to claims, legal process (including subpoenas), to protect our rights and
        ...
        <p>
          Sell Easy will collect personal information that you submit to us. We may also receive
        ...
        <p>
          ...
          cancel your participation in any of these email lists at any time by clicking on the
          opt-out link or other unsubscribe option that is included in the respective email. We only
          send emails to people who have authorized us to contact them, either directly, or through
          a third party. We do not send unsolicited commercial emails, because we hate spam as much
          as you do. By submitting your email address, you also agree to allow us to use your email
          ...
          addresses submitted only through the order processing page will be used for the sole
          purpose of sending you information and updates pertaining to your order. If, however, you
          have provided the same email to us through another method, we may use it for any of the
          purposes stated in this Policy. Note: If at any time you would like to unsubscribe from
          receiving future emails, we include detailed unsubscribe instructions at the bottom of
          each email.
        </p>
        <h2>How Long Do We Keep Your Information?</h2>
        <p>
          We keep your information only so long as we need it to provide Sell Easy to you and
        ...
        <p>
          ...
          of any information you transmit to Sell Easy or guarantee that your information on the
        ...
        <p>
          Sell Easy is incorporated in India. Information collected via our website, through direct
        ...
        <h2>Is the information collected through the Sell Easy Service secure?</h2>
        <p>
        ...
        <p>
          The rights you have to request updates or corrections to the information Sell Easy
          collects depend on your relationship with Sell Easy. Personnel may update or correct their
        ...
        <p>
          ...
          the following paragraph), by&nbsp;cancelling your account. Such updates, corrections,
          ...
          prior to such update, correction, change or deletion. To protect your privacy and
          security, we may take reasonable steps (such as requesting a unique password) to verify
          your identity before granting you profile access or making corrections. You are
          responsible for maintaining the secrecy of your unique password and account information at
          all times.
        </p>
        <p>
        ...
        <h2>Personnel</h2>
        <p>
          If you are a Sell Easy worker or applicant, we collect information you voluntarily provide
        ...
        <p>
          ...
          merger or other transfer of all or substantially all of the assets of Sell Easy or any of
          its Corporate Affiliates (as defined herein), or that portion of Sell Easy or any of its
        ...
        <p>
          ...
          Affiliates. For purposes of this Privacy Policy, &quotCorporate Affiliate&quot means any
          person or entity which directly or indirectly controls, is controlled by or is under
          common control with Sell Easy, whether by ownership or otherwise. Any information relating
          to you that we provide to our Corporate Affiliates will be treated by those Corporate
          Affiliates in accordance with the terms of this Privacy Policy.
        </p>
        <h2>Governing Law</h2>
        <p>
          This Privacy Policy is governed by the laws of India without regard to its conflict of
        ...
        <p>
          The laws of India, excluding its conflicts of law rules, shall govern this Agreement and
          your use of the app. Your use of the app may also be subject to other local, state,
          national, or international laws.
        </p>
        <p>
          By using Sell Easy or contacting us directly, you signify your acceptance of this Privacy
        ...
        <p>
          ...
          into what is being set when you visit our site and how it&apos;s being used. By using our
        ...
        <p>
          ...
          websites not operated or controlled by Sell Easy. We are not responsible for the content,
        ...
        <h2>Cookies</h2>
        <p>
          Sell Easy uses &quotCookies&quot to identify the areas of our website that you have
        ...
        <p>
          ...
          visited your website. It allows your company to seem like they&apos;re “following” people
        ...
        <p>
          ...
          websites or services (&quotThird- Party Services&quot).
        </p>
        <p>
        ...
        <p>
          ...
          your advertising by understanding the actions people take on your website. You can use
          the&nbsp;pixel&nbsp;to: Make sure your ads are shown to the right people. Facebook pixel
          may collect information from your device when you use the service. Facebook pixel collects
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              videos may become unavailable or you would be required to enter your login details
              every time you visit the $platform as we would not be able to remember that you had
          ...
          <li>
            ...
            <p>
              ...
              similar to cookies but with a greatly enhanced capacity and no information stored in
          ...
          <li>
            ...
            <br />
            <p>
              $elnombre uses &quotSessions&quot to identify the areas of our website that you have
        ...
        <ul>
          ...
          <li>
            ...
            also request a copy of their data, and that their data be updated, deleted, restricted,
        ...
        <p>
          ...
          simply the right thing to do. At Sell Easy we strongly believe that your data privacy is
        ...
        <p>
          ...
          of GDPR. Sell Easy processes or stores all personal data in fully vetted, DPA compliant
        ...
        <p>
          ...
          your data and your customers data. Our customer&nbsp;support team is here for you to
