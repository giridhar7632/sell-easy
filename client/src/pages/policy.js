...
const privacyPolicy = () => {
  return (
    <div>
      <Head>
        <title>Cloutflow | Privacy Policy</title>
        <meta name="privacy-policy" content="Take your brand to the moon 🚀" />
...
const Policy = () => {
  return (
    <div>
      ...
      <p>
        {' '}
        Cloutflow (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy
      ...
      <p>
        ...
        “Service”) alongside our application, Cloutflow. By accessing or using our Service, you
      ...
      <ul>
        ...
        <li>
          Country: where Cloutflow or the owners/founders of Cloutflow are based, in this case is
          India
        </li>
        <li>
          Customer:refers to the company, organization or person that signs up to use the Cloutflow
        ...
        <li>
          ...
          that can be used to visit Cloutflow and use the services.
        </li>
        <li>
          ...
          An IP address can often be used to identify the location from which a device is connecting
          to the Internet.
        </li>
        <li>
          Personnel:refers to those individuals who are employed by Cloutflow or are under contract
      ...
      <p />
      <h1>When does Cloutflow use end user information from third parties?</h1>
      <p>
        Cloutflow will collect End User Data necessary to provide the Cloutflow services to our
        customers.
      </p>
      <p>
      ...
      <h1>When does Cloutflow use customer information from third parties?</h1>
      <p>
        We receive some information from the third parties when you contact us. For example, when
        you submit your email address to us to show interest in becoming a Cloutflow customer, we
        receive information from a third party that provides automated fraud detection services to
        Cloutflow. We also occasionally collect information that is made publicly available on
      ...
      <p>
        ...
        reporting for us and our advertisers.&nbsp;We may also disclose personal and non-personal
        information about you to government or law enforcement officials or private parties as we,
        in our sole discretion, believe necessary or appropriate in order to respond to claims,
        legal process (including subpoenas), to protect our rights and interests or those of a third
        party, the safety of the public or any person, to prevent or stop any illegal, unethical, or
        legally actionable activity, or to otherwise comply with applicable court orders, laws,
        rules and regulations.
      </p>
      <h1>Where and when is information collected from customers and end users?</h1>
      <p>
        Cloutflow will collect personal information that you submit to us. We may also receive
      ...
      <p>
        We keep your information only so long as we need it to provide Cloutflow to you and fulfill
        ...
        regulatory obligations, we’ll either remove it from our systems or depersonalize it so that
      ...
      <p>
        ...
        any information you transmit to Cloutflow or guarantee that your information on the Service
      ...
      <p>
        Cloutflow is incorporated in India. Information collected via our website, through direct
        ...
        viewed and hosted anywhere in the world, including countries that may not have laws of
      ...
      <h1>Is the information collected through the Cloutflow Service secure?</h1>
      <p>
      ...
      <p>
        The rights you have to request updates or corrections to the information Cloutflow collects
        depend on your relationship with Cloutflow. Personnel may update or correct their
      ...
      <p>
        ...
        following paragraph), by&nbsp;cancelling your account. Such updates, corrections, changes
        and deletions will have no effect on other information that we maintain, or information that
      ...
      <h1>Personnel</h1>
      <p>
        If you are a Cloutflow worker or applicant, we collect information you voluntarily provide
      ...
      <p>
        ...
        or other transfer of all or substantially all of the assets of Cloutflow or any of its
        Corporate Affiliates (as defined herein), or that portion of Cloutflow or any of its
      ...
      <p>
        ...
        control with Cloutflow, whether by ownership or otherwise. Any information relating to you
      ...
      <p>
        ...
        action or dispute arising between the parties under or in connection with this Privacy
      ...
      <p>
        By using Cloutflow or contacting us directly, you signify your acceptance of this Privacy
      ...
      <p>
        ...
        app, registering an account, or making a purchase, you hereby consent to our Privacy Policy
        and agree to its terms.
      </p>
      <h1>Links to Other Websites</h1>
      <p>
        This Privacy Policy applies only to the Services. The Services may contain links to other
        websites not operated or controlled by Cloutflow. We are not responsible for the content,
      ...
      <h1>Cookies</h1>
      <p>
        Cloutflow uses &quotCookies&quot to identify the areas of our website that you have visited.
      ...
      <p>
        ...
        services (&quotThird- Party Services&quot).
      </p>
      <p>
      ...
      <p>
        ...
        the&nbsp;pixel&nbsp;to: Make sure your ads are shown to the right people. Facebook pixel may
        collect information from your device when you use the service. Facebook pixel collects
      ...
      <p>
        ...
        simply the right thing to do. At Cloutflow we strongly believe that your data privacy is
      ...
      <p>
        ...
        GDPR. Cloutflow processes or stores all personal data in fully vetted, DPA compliant
