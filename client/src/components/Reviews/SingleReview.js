...
const SingleReview = ({ comment, reviewer, createdAt }) => {
  return (
    <div class="mb-2 rounded-lg border border-gray-200 shadow-sm dark:border-gray-700">
      <figure class="flex flex-col rounded-lg border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
        <blockquote class="mx-auto mb-2 w-full dark:text-gray-400">
